...
import CometChatSenderAnswerMessageBubble from '../CometChatSenderAnswerMessageBubble';
import CometChatReceiverAnswerMessageBubble from '../CometChatReceiverAnswerMessageBubble';
      ...
      switch (message.type) {
        case CometChat.MESSAGE_TYPE.TEXT:
          ...
          if (matchTrue || matchFalse) {
            ...
            component = array[0] ? (
              <CometChatSenderAnswerMessageBubble
      ...
      switch (message.type) {
        ...
        case CometChat.MESSAGE_TYPE.TEXT:
          ...
          if (matchTrue || matchFalse) {
            let array = string.split("--");
            component = array[0] ? (
              <CometChatReceiverAnswerMessageBubble
                loggedInUser={this.loggedInUser}
                theme={this.props.theme}
                key={key}
                item={this.props.item}
        ...
        case 'answer':
          component = (
            <CometChatSenderTextMessageBubble
              ...
              widgetconfig={this.props.widgetconfig}
              actionGenerated={this.props.actionGenerated}
              showMessage={message.data.customData.message}
            />
          )
        default:
          break;
