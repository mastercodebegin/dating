...
const CometChatSenderAnswerMessageBubble = (props) => {
  ...
  const getMessageText = () => {
    return (
      ...
      // />
      <Text style={style.autoLinkStyle}>{`I would choose to ${props.messageText}`}</Text>
    );
  };
  useEffect(() => {
...
export default CometChatSenderAnswerMessageBubble;
