...
const CometChatReceiverAnswerMessageBubble = (props) => {
  ...
  const getMessageText = () => {
    return (
      ...
      // />
      <Text style={style.autolinkStyle}>{`I think they would choose a ${props.messageText}`}</Text>
    );
  };
  useEffect(() => {
            ...
            <TouchableWithoutFeedback
              ...
              <View style={{ flexDirection: 'row' }}>
                <View style={style.chatView}>
                  ...
                  {props.answer === 'true' ? <Image source={require("./resources/check.png")} style={style.greenRoundedStyle} /> : <Image source={require("./resources/cross.png")} style={style.redRoundedStyle} />}
                </View>
              </View>
            </TouchableWithoutFeedback>
          </View>
...
export default CometChatReceiverAnswerMessageBubble;
