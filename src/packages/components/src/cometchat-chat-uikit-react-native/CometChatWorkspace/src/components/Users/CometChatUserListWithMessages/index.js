...
class CometChatUserListWithMessages extends React.Component {
  ...
  removeFocusListener = this.props.navigation.addListener('willFocus', () => this.setState({isActive: true}))
  removeBlurListener = this.props.navigation.addListener('willBlur', () => this.setState({isActive: false}))
  ...
  componentDidUpdate(prevProps) {
    if(prevProps.updatedSuggestedUsersChatList.length !== this.props.updatedSuggestedUsersChatList.length) {
      this.setState({
        updatedSuggestedUsersChatList: this.props.updatedSuggestedUsersChatList
      });
    }
  }
      ...
      <CometChatContextProvider ref={(el) => (this.contextProviderRef = el)}>
        <View style={{ backgroundColor: 'white' }}>
          <CometChatUserList
            ...
            updatedSuggestedUsersChatList={this.state.updatedSuggestedUsersChatList}
          />
          {imageView}
          {this.state.isActive ? 
          <>
