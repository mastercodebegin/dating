    ...
    return (
      <View style={styles.headerContainer}>
        <TouchableOpacity
          ...
          /> */}
          <Image source={arrow_left} style={styles.arrowLeftIcon} />
        </TouchableOpacity>
        <View style={styles.headerDetailContainer}>
          ...
          <View style={styles.scoreBoxView}>
            <View style={styles.scoreBox}>
              <Text style={styles.scoreTextStyle}>{this.props.userGameScore}</Text>
              <Text style={styles.userNameStyle}>{this.props.userName}</Text>
            </View>
            <View style={styles.scoreBox}>
              <Text style={styles.scoreTextStyle}>{this.props.friendGameScore}</Text>
              <Text style={styles.userNameStyle}>{this.props.frdName}</Text>
            </View>
          </View>
          {/* {videoCallBtn}
          {audioCallBtn}
