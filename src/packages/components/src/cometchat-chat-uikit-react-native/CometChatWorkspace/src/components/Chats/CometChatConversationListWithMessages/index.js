...
class CometChatConversationListWithMessages extends React.Component {
  ...
  removeFocusListener = this.props.navigation.addListener('willFocus', () =>
    this.setState({ isActive: true }),
  );
  removeBlurListener = this.props.navigation.addListener('willBlur', () =>
   ...
   */
  itemClicked = (item, type, username, photo) => {
  ...
  render() {
    ...
    // console.log("BBBB", this.state.item)
