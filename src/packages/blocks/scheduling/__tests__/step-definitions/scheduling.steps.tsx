  ...
  test("User navigates to scheduling", ({ given, when, then }) => {
    ...
    then('I can check api with out errors', () => {
      ...
      magLogInSucessRestAPI.addData(
        ...
        instance.serviceProviderScheduleApiId = magLogInSucessRestAPI.messageId;
    ...
    then('I can check api with errors', () => {
      ...
      magLogInSucessRestAPI.addData(
        ...
        instance.serviceProviderDetailApiId = magLogInSucessRestAPI.messageId;
        runEngine.sendMessage("Unit Test", magLogInSucessRestAPI);
    ...
    then('I can check api with null', () => {
      ...
      magLogInSucessRestAPI.addData(
        ...
        instance.serviceProviderDetailApiId = magLogInSucessRestAPI.messageId;
        runEngine.sendMessage("Availability Message Received", magLogInSucessRestAPI);
    ...
    then("I can check events", () => {
      let plans4 = schedulingBlock.findWhere((node) => node.prop('testID') === "getServiceProviderAvailability");
      plans4.simulate('press')
    });
    
    
    then("I can leave the screen with out errors", () => {
      let plans4 = schedulingBlock.findWhere((node) => node.prop('testID') === "getServiceProviderAvailability1");
      plans4.simulate('press')
