          ...
          >
            ...
            <View>
              <TouchableOpacity
                ...
                testID="UpdateApiTestID"
              >
                <Text style={styles.titleWhySignUp}>validateMobileAndThenUpdateUserProfile</Text>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => this.validateMobileOnServer(null, null)}
                testID="validateMobileOnServerTestID"
              >
                <Text style={styles.titleWhySignUp}>validateMobileOnServer</Text>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => this.validateAndUpdateProfile()}
                testID="validateAndUpdateProfileTestID"
              >
                <Text style={styles.titleWhySignUp}>validateAndUpdateProfile</Text>
              </TouchableOpacity>

              <TouchableOpacity
                onPress={() => this.goToPrivacyPolicy()}
                testID="goToPrivacyTestID"
              >
                <Text style={styles.titleWhySignUp}>validateAndUpdateProfile</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                testID="btnReTypePasswordShowHidePropsTestID"
              >
                <Text style={styles.titleWhySignUp}>btnReTypePasswordShowHideProps</Text>
              </TouchableOpacity>

              <TouchableOpacity
                {...this.btnDisableEditPasswordProps}
                testID="btnDisableEditPasswordPropsTestID"
              >
                <Text style={styles.titleWhySignUp}>btnDisableEditPasswordProps</Text>
              </TouchableOpacity>

              <TouchableOpacity
                {...this.btnNewPasswordShowHideButtonProps}
                testID="btnNewPasswordShowHideButtonPropsTestID"
              >
                <Text style={styles.titleWhySignUp}>btnNewPasswordShowHideButtonProps</Text>
              </TouchableOpacity>

              <TouchableOpacity
                {...this.btnPasswordShowHideButtonProps}
                testID="btnPasswordShowHideButtonPropsTestID"
              >
                <Text style={styles.titleWhySignUp}>btnPasswordShowHideButtonProps</Text>
              </TouchableOpacity>

              <TouchableOpacity
                {...this.btnEnableEditPasswordProps}
                testID="btnEnableEditPasswordPropsTestID"
              >
                <Text style={styles.titleWhySignUp}>btnEnableEditPasswordProps</Text>
              </TouchableOpacity>

              <TouchableOpacity
                {...this.txtInputPhoneNumberlWebProps}
                testID="txtInputPhoneNumberlWebProps"
              >
                <Text style={styles.titleWhySignUp}>btnEnableEditPasswordProps</Text>
              </TouchableOpacity>
              ...
              <TextInput
                testID={"txtInputNewPasswordProps"} //Merge Engine::From BDS
                style={styles.bgInput} //UI Engine::From Sketch
              ...
              <TextInput
                testID={"updatelastNameState"} //Merge Engine::From BDS
                style={styles.bgInput} //UI Engine::From Sketch
                placeholder={this.lastName} //UI Engine::From Sketch
                onChangeText={()=>this.setState({lastName: null})}
              />
              ...
              <TextInput
                testID={"txtInputCurrentPasswordProps"} //Merge Engine::From BDS
              ...
              <TextInput
                testID={"txtInputEmailWebProps"} //Merge Engine::From BDS
                style={styles.bgInput} //UI Engine::From Sketch
                placeholder={this.labelEmail} //UI Engine::From Sketch
                {...this.txtInputEmailWebProps} //Merge Engine::From BDS - {...this.testIDProps}
              />

              <TextInput
                testID={"txtInputFirstNameProps"} //Merge Engine::From BDS
                style={styles.bgInput} //UI Engine::From Sketch
                placeholder={this.labelEmail} //UI Engine::From Sketch
              ...
              <TextInput
                testID={"txtInputLastNameProps"} //Merge Engine::From BDS
                style={styles.bgInput} //UI Engine::From Sketch
                placeholder={this.labelEmail} //UI Engine::From Sketch
              ...
              <TouchableOpacity
                {...this.txtInputPhoneNumberlWebProps}
                testID="txtInputEmailWebPropsPress"
              >
                <Text style={styles.titleWhySignUp}>btnEnableEditPasswordProps</Text>
              </TouchableOpacity>
              ...
              <TextInput
                onChangeText={() => this.txtInputPhoneNumberlWebProps.editable = true}
                testID={"txtInputPhoneNumberlWebPropsPress"} //Merge Engine::From BDS
                style={styles.bgInput} //UI Engine::From Sketch
                placeholder={this.labelEmail} //UI Engine::From Sketch
              />
