...
exports.apiGetUserProfile = "account_block/accounts/edit_user_profile";
exports.apiGetUserProfileEndPoint = "bx_block_profile/profiles/user_profiles";
exports.apiFormDataContentType = "multipart/form-data";

exports.plsEnterName = "Please enter your name";
exports.errorFirstNameMoreThanThreeCharacters = "Name is accepted minimum of 3 characters";
exports.errorFirstNameLessThanFourtyCharacters = "Name is accepted maximum of 40 characters";
exports.errorFirstNameNotValid = "Name should accept only Alphabetics";
exports.errorEmailNotValid = "Please enter valid email Id.";
exports.erroruserFirstNameMoreThanThreeCharacters = "UserName is accepted minimum of 3 characters";
exports.plsEnterUserName = "Please enter the Username";
exports.errorUserFirstNameLessThanFourtyCharacters = "User name should contain 3-20 characters, including at least one letter";
exports.errorUserFirstNameNotValid = "The user name should contain 3-20 characters, Value should contain alpha-numeric";
