...
const feature = loadFeature('./__tests__/features/CvresumeCandidateManagement2-scenario.feature');
...
defineFeature(feature, (test) => {
    ...
    test('User navigates to CvresumeCandidateManagement2', ({ given, when, then }) => {
        let exampleBlockA:ShallowWrapper;
        let instance:CvresumeCandidateManagement2; 

        given('I am a User loading CvresumeCandidateManagement2', () => {
            exampleBlockA = shallow(<CvresumeCandidateManagement2 {...screenProps}/>);
        });

        when('I navigate to the CvresumeCandidateManagement2', () => {
             instance = exampleBlockA.instance() as CvresumeCandidateManagement2
        });
