...
exports.errorPasswordEnter = "Please enter your password.";
exports.errorConfirmPasswordEnter = "Please enter your confirm password.";
exports.errorEmailNotValid='please enter a valid email id'
exports.validationApiContentType='application/json' 
exports.verifyEmailOtpApiEndPoint='bx_block_forgot_password/otps/otp_confirmation'
exports.verifyOtpEmail="bx_block_signup/email_confirmation"
exports.updatePasswordEndPoint='bx_block_forgot_password/otps/password_confirmation'
exports.phoneRegExp = /^((\\+[1-9]{1,4}[ \\-]*)|(\\([0-9]{2,3}\\)[ \\-]*)|([0-9]{2,4})[ \\-]*)*?[0-9]{3,4}?[ \\-]*[0-9]{3,4}?$/;
exports.errorPasswordEnter = "Please enter your password.";
exports.errorPasswordNotValid = 'Password should contain 8-16 characters.';
exports.errorConfirmPasswordEnter = "Please enter your confirm password.";
